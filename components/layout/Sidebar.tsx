...
const NAV_ITEMS: NavItem[] = [
  ...
  { href: '/os',           label: 'Ordens de Serviço',     icon: FileText,        module: 'os'           },
    ...
    <div className="flex flex-col h-full">
      ...
      {(profile as any).is_superadmin && (
        <div className="px-3 pb-2">
          <Link
            href="/superadmin"
            className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors bg-purple-700/40 text-purple-200 hover:bg-purple-700/70 hover:text-white"
          >
